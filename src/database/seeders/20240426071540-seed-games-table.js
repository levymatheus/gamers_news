...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('games', [
      ...
      { name: 'Resident Evil 4 Remake', synopsis: "aasdasdasdasdasdasdasdasdadasdasd".', featured: true, category_id: categories[0].id, created_at: new Date(), updated_at: new Date() },
